...
webtasks = {'webServer' : ['bun run ', 'server.js', './webServer/src/server'], 'webInterface' :['npm run start','','./noyaab-front'],'llmEngine' : ['python','sympllmTcpserver.py','./LlmEngine/myenvi/quantized'],'translateEngine': ['python', 'sympTranslate.py' , './LlmEngine/myenvi/quantized']};

#
# webtasks = {'webServer' : ['bun run ', 'server.js', './webServer/src/server'], 'webInterface' :['npx webpack server --mode development','','./'],'llmEngine' : ['python','sympllmTcpserver.py','./LlmEngine/llmEngine/quantized']};
#
