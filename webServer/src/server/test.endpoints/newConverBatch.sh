...
curl -d '{"reqType":"batch","context":[{"id":1,"cat":"softwareEngineer" , "promptValue":"hi whatsapp"},{"id":2,"cat":"gen" , "promptValue":"hi"},{"id":3,"cat":"medical" , "promptValue":"hi doctor i have headache ask me 3 questions in order to diagnose me "}]}' -H "Content-Type: application/json" -X POST http://localhost:8080/newConverBatch
